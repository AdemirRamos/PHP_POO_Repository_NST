<?php
    ...
    //Na pasta "vendor", temos todos os pacotes e dependências de terceiros.
    ...
    //Após o download do novo pacote, o seu arquivo "composer.json" vai ser atualizado e mostrará o novo pacote baixado.
